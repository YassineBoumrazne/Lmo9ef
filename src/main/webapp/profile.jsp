                            ...
                            <div class="login-register-form">
                                    ...
                                    <div class="mt-2">
                                        <div class="p-2 d-flex justify-content-center">
                                            <div class="d-flex align-items-center flex-column">
                                                <img id="blahS" src="assets\img\photos\Profile_example.png" alt="your image" width="256" height="256">
                                                <input type="file" onchange="readURL(this);" name="file-1S[]" id="file-1S" class="inputfile inputfile-1" accept="image/png, image/gif, image/jpeg">
                                    ...
                                    <div class="mt-2">
                                        <div class="p-2">
                                            <div class="mb-5">
                                                ...
                                                <div class="mt-3 text-muted">Vous pouvez accéder ou modifier vos données à tout moment.</div>
                                            </div>
                                            <div class="row g-4 mt-2">
                                                <div class="col-6">
                                                    <label class="form-label">Nom</label>
                                                    <input type="text" class="form-control" placeholder="Nom" id="NomS" name="NomS" value="<%=((Seller) logedInUser).getLastName()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Prenom</label>
                                                    <input type="text" class="form-control" placeholder="Prenom" id="PrenomS" name="PrenomS" value="<%=logedInS.getFirstName()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Numéro de Téléphone</label>
                                                    <input type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onpaste="return false;" class="form-control" placeholder="Numéro de Téléphone" id="NumTelephoneS" name="NumTelephoneS" value="<%=logedInS.getPhoneNumber()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Date de Naissance</label>
                                                    <input type="date" class="form-control" placeholder="Date de Naissance" id="DateDeNaissanceS" name="DateDeNaissanceS"value="<%=logedInS.getBirthDay()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Addresse</label>
                                                    <input type="text" class="form-control" placeholder="Addresse" id="AddresseS" name="AddresseS" value="<%=logedInS.getAddress()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Email</label>
                                                    <input type="email" class="form-control" placeholder="Email" id="EmailS" name="EmailS"value="<%=logedInS.getEmail()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                ...
                                                <div class="col-6">
                                                    ...
                                                    <select class="form-select" aria-label="Default select example" name="ExperienceS" id="ExperienceS">
                                                        <option selected="">Experience</option>
                                                        <%
                                                            ArrayList<String> Experience = new ArrayList<String>();
                                                            Experience = authRepositroy.getExperience();
                                                            for (String exp: Experience) {
                                                        %>
                                                        <option value="<%=exp%>"><%=exp%> ans</option>
                                                        <%
                                                            }
                                                        %>
                                                    </select>
                                            ...
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Ville" id="VilleS" name="VilleS" value="<%=logedInS.getVille()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Pays</label>
                                                    <input type="Text" class="form-control" placeholder="Pays" id="PaysS" name="PaysS"value="<%=logedInS.getPays()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-12">
                                                    <label class="form-label">Description</label>
                                                    <textarea class="form-control" id="DescriptionS" name="DescriptionS" rows="4" cols="50"><%=logedInS.getDescription()%></textarea>
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Hourly Rate</label>
                                                    <input type="number" class="form-control" placeholder="HourlyRate" id="HourlyRateS" name="HourlyRateS" value="<%=logedInS.getPrice()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Working Time</label>
                                                    <textarea class="form-control" id="WorkingTimeS" name="WorkingTimeS" rows="4" cols="50"><%=logedInS.getWorkingTime()%></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <form method="post" action="update">
                                    ...
                                    <div class="mt-2">
                                        <div class="p-2 d-flex justify-content-center">
                                            <div class="d-flex align-items-center flex-column">
                                                <img id="blahC" src="assets\img\photos\Profile_example.png" alt="your image" width="256" height="256">
                                                <input type="file" onchange="readURL(this);" name="file-1C[]" id="file-1C" class="inputfile inputfile-1" accept="image/png, image/gif, image/jpeg">
                                    ...
                                    <div class="mt-2">
                                        <div class="p-2">
                                            ...
                                            <div class="row g-4 mt-2">
                                                <div class="col-6">
                                                    <label class="form-label">Nom</label>
                                                    <input type="text" class="form-control" placeholder="Nom" id="NomC" name="NomC" value="<%=logedInC.getLastName()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Prenom</label>
                                                    <input type="text" class="form-control" placeholder="Prenom" id="PrenomC" name="PrenomC" value="<%=logedInC.getFirstName()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Numéro de Téléphone</label>
                                                    <input type="text" oninput="this.value=this.value.replace(/[^0-9]/g,'');" onpaste="return false;" class="form-control" placeholder="Numéro de Téléphone" id="NumTelephoneC" name="NumTelephoneC" value="<%=logedInC.getPhoneNumber()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Date de Naissance</label>
                                                    <input type="date" class="form-control" placeholder="Date de Naissance" id="DateDeNaissanceC" name="DateDeNaissanceC"value="<%=logedInC.getBirthDay()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Addresse</label>
                                                    <input type="text" class="form-control" placeholder="Addresse" id="AddresseC" name="AddresseC" value="<%=logedInC.getAddress()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Email</label>
                                                    <input type="email" class="form-control" placeholder="Email" id="EmailC" name="EmailC" value="<%=logedInC.getEmail()%>">
                                                </div>
                                            </div>
                                            <div class="row g-4 mt-3">
                                                <div class="col-6">
                                                    <label class="form-label">Ville</label>
                                                    <input type="text" class="form-control" placeholder="Ville" id="VilleC" name="VilleC" value="<%=logedInC.getCity()%>">
                                                </div>
                                                <div class="col-6">
                                                    <label class="form-label">Pays</label>
                                                    <input type="Text" class="form-control" placeholder="Pays" id="PaysC" name="PaysC"value="<%=logedInC.getPay()%>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
