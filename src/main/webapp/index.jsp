                                ...
                                <div class="row justify-content-center align-items-center">
                                    <div class="col-12 col-lg-8">
                                        <div class="slider-content">
                                            ...
                                            <p class="desc">Trouvez le service dont vous avez besoin parmi les nombreux services proposés. De la plomberie aux services d'un handyman, vous trouverez tout sur cette plateforme.</p>
                                        </div>
                                    </div>
                                    <div class="col-12">
                ...
                <div class="working-process-content-wrap">
                    <div class="working-col">
                        ...
                        <div class="working-process-item">
                            ...
                            <div class="content">
                                ...
                                <p class="desc">Les clients créent un compte sur le site Web et fournissent des détails sur le service dont ils ont besoin et leur emplacement.</p>
                            </div>
                    ...
                    <div class="working-col">
                        ...
                        <div class="working-process-item">
                            ...
                            <div class="content">
                                <h4 class="title">Recherche de correspondance et présentation des fournisseurs</h4>
                                <p class="desc">Le site Web recherche une correspondance entre la demande du client et les fournisseurs qui offrent le service dans la zone du client. Une fois la correspondance trouvée, le client reçoit une liste de fournisseurs disponibles et de leurs profils.</p>
                            </div>
                            <div class="shape-arrow-icon">
                                <img class="shape-icon" src="assets/img/icons/right-arrow.png" alt="Image-HasTech">
                                <img class="shape-icon-hover" src="assets/img/icons/right-arrow2.png" alt="Image-HasTech">
                    ...
                    <div class="working-col">
                        ...
                        <div class="working-process-item">
                            ...
                            <div class="content">
                                ...
                                <p class="desc">Le client parcourt les profils et choisit le fournisseur avec lequel il souhaite travailler. Ensuite, le client contacte le fournisseur directement pour discuter de détails supplémentaires et réserver le service. Le paiement pour le service est traité via le site Web</p>
                            </div>
        ...
        <div class="row">
            <div class="col-12">
                <div class="section-title text-center" >
                    ...
                    <div class="desc">
                        <p>Nos clients sont notre priorité, et nous sommes heureux de leur offrir des produits et services de qualité exceptionnelle. Nous travaillons dur pour nous assurer que chaque client est satisfait de ce que nous proposons et que nous leur offrons une expérience de magasinage agréable. </p>
                    </div>
                </div>
            </div>
        </div>
                            ...
                            <div class="testimonial-item">
                                <div class="testi-inner-content">
                                    ...
                                    <div class="testi-content">
                                        <p class="desc">"J'ai trouvé le El moukef pour les homeservices très utile. Il est très bien organisé et propose des informations précises et complètes sur les services disponibles. Les outils et les fonctionnalités sont très utiles et les tarifs sont très compétitifs. Je recommande vivement ce El moukef à tous ceux qui recherchent des services à domicile."</p>
                                        <div class="rating-box">
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-inner-content">
                                    ...
                                    <div class="testi-content">
                                        <p class="desc">"J'ai trouvé ce El moukef pour les homeservices très pratique et facile à utiliser. Il est très bien organisé et fournit des informations précises et complètes sur les services disponibles. Les outils et les fonctionnalités sont très utiles et les tarifs sont très compétitifs. Je recommande vivement ce El moukef à tous ceux qui recherchent des services à domicile."</p>
                                        <div class="rating-box">
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-inner-content">
                                    ...
                                    <div class="testi-content">
                                        <p class="desc">"Je suis très satisfait du service que j'ai reçu de ce El moukef pour les homeservices. Les outils et les fonctionnalités sont très utiles et les tarifs sont très compétitifs. Les informations sont très claires et complètes et le site est très bien organisé. Je recommande fortement ce El moukef à tous ceux qui recherchent des services à domicile."</p>
                                        <div class="rating-box">
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                        ...
                        <div class="swiper-slide">
                            ...
                            <div class="testimonial-item">
                                <div class="testi-inner-content">
                                    ...
                                    <div class="testi-content">
                                        <p class="desc">"Le El moukef pour les services à domicile est très facile à utiliser et très bien organisé. Il propose des informations précises et complètes sur les services disponibles. Les outils et les fonctionnalités sont très utiles et les tarifs sont très compétitifs. Je recommande vivement ce El moukef à tous ceux qui recherchent des services à domicile."</p>
                                        <div class="rating-box">
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
                                            <i class="icofont-star"></i>
